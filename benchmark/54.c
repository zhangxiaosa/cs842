...
static int32_t  func_1(void)
{ /* block id: 0 */
    const int16_t l_8[1] = {(-1L)};
    uint8_t l_9 = 0x9AL;
    int32_t *l_10 = &g_11;
    int i;
    (*l_10) &= ((g_2 != 0x449CL) && ((g_2 & (safe_sub_func_int16_t_s_s(3L, ((safe_sub_func_int8_t_s_s((safe_unary_minus_func_uint32_t_u(((l_8[0] >= (g_2 < l_8[0])) , (l_8[0] <= g_2)))), l_9)) == l_9)))) > 254UL));
    return (*l_10);
}
