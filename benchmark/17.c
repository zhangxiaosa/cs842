...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int64_t l_11 = 0x6BAFCB143E95AAD8LL;
    for (g_3 = 23; (g_3 >= (-8)); g_3 = safe_sub_func_int16_t_s_s(g_3, 1))
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        uint64_t l_8 = 0x90BE4438BEA12209LL;
        l_8++;
        (*l_6) = (l_11 |= (*l_6));
        for (l_8 = (-1); (l_8 <= 48); l_8 = safe_add_func_uint8_t_u_u(l_8, 7))
        { /* block id: 9 */
            for (g_7 = 0; (g_7 != (-30)); g_7 = safe_sub_func_uint8_t_u_u(g_7, 3))
            { /* block id: 12 */
                return l_11;
            }
        }
